  ...
  <div class="col-md-5 mb-4">
    ...
    <div id="address" class="mb-3">
      {% if site.data.info.address.building == "경기대" %}
        ...
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://kko.to/HOCV-V5aH" target="_blank"> {{ site.data.info.address.office }} </a> (Office), {{ site.data.info.address.lab }} (Lab)<BR>
      {% endif %}
