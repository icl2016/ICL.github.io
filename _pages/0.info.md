  ...
  <div class="col-md-5 mb-4">
    <div id="affiliation">
      ...
      {% for item in site.data.info.affiliation %}
        <p><i style="width: 1.5em;" class="fa fa-university" aria-hidden="true"></i><a href="https://www.kyonggi.ac.kr/" target="_blank" >경기대학교</a> {{item.school }}<BR>
    ...
    <div id="map" class="mb-3">
      ...
      {% if site.data.info.address.building == "경기대" %}
        <!-- * 카카오맵 - 지도퍼가기 -->
        <div id="daumRoughmapContainer1643972541537" class="root_daum_roughmap root_daum_roughmap_landing"></div>
        <script charset="UTF-8">
          new daum.roughmap.Lander({
            "timestamp" : "1643972541537",
            "key" : "29zu5",
    ...
    <div id="address" class="mb-3">
      {% if site.data.info.address.building == "경기대" %}
        <i style="width: 1.5em;" class="fa fa-location-arrow"></i>16227 경기도 수원시 영통구 광교산로 154-42<BR>
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="https://map.kakao.com/?map_type=TYPE_MAP&itemId=98219298" target="_blank"> {{ site.data.info.address.office }} (Office), {{ site.data.info.address.lab }} (Lab)<BR>
      {% else %}
